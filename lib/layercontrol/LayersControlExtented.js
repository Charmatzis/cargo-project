...
var _leaflet2 = require('./leaflet.groupedlayercontrol');
...
var LayersControlExtented = function (_MapControl) {
  _inherits(LayersControlExtented, _MapControl);

  function LayersControlExtented() {
    _classCallCheck(this, LayersControlExtented);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(LayersControlExtented).apply(this, arguments));
  }

  _createClass(LayersControlExtented, [{
    ...
    value: function componentWillMount() {
      ...
      if (this.legacy) {
        ...
        this.leafletElement = new L.Control.GroupedLayers(undefined, undefined, options);
        this.controlProps = {
    ...
    value: function addOverlay(layer, name) {
      ...
      this.leafletElement.addOverlay(layer, name, 'Overlay');
    }
  }, {
    key: 'removeLayer',
    value: function removeLayer(layer) {
    ...
    key: 'handleVisibilityImageProperties',
    value: function handleVisibilityImageProperties() {
      var obj = this;
      var value = false;
      this.props.updateVisibilityImageProperties(value);
    }
  }, {
    ...
    value: function getClonedChildrenWithProps(extra) {
      ...
      var props = (0, _lodash.assign)({ layerContainer: layerContainer, map: map }, extra);
    ...
    value: function remove(layer) {
      return function (e) {
        e.preventDefault();
        return this.props.onRemove(layer);
      }.bind(this);
    }
  }, {
    key: 'render',
  ...
  return LayersControlExtented;
}(_reactLeaflet.MapControl);

LayersControlExtented.propTypes = {
...
exports.default = LayersControlExtented;


LayersControlExtented.BaseLayer = BaseLayer;
LayersControlExtented.Overlay = Overlay;