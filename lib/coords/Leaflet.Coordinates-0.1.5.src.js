...
L.Control.Coordinates = L.Control.extend({
  ...
  */
	_createInput: function _createInput(classname, container) {
	...
	_clearMarker: function _clearMarker() {
  ...
  */
	_createCoordinateLabel: function _createCoordinateLabel(ll) {
  ...
  */
	_getNumber: function _getNumber(n, opts) {
		var res;
		if (opts.useDMS) {
  ...
  */
	_switchUI: function _switchUI(evt) {
		L.DomEvent.stop(evt);
  ...
  */
	...
	_createNewMarker: function _createNewMarker() {
...
L.NumberFormatter = {
	round: function round(num, dec, sep) {
	...
	createValidNumber: function createValidNumber(num, sep) {
		if (num && num.length > 0) {
